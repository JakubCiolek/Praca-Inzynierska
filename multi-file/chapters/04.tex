...
Aplikacja została stworzona w środowisku Unity i zapewnia interaktywną symulację rozprzestrzeniania się zarażeń w przestrzeni biurowej. Przeznaczona jest głównie dla użytkowników korzystających z komputerów osobistych z systemem operacyjnym Windows.
...
\begin{itemize}
	\item Ustawianie Parametrów Symulacji
			odbywa się poprzez wybranie odpowiednich wartości na suwakach.
	\item Rozpoczęcie symulacji i jej kontrola.
